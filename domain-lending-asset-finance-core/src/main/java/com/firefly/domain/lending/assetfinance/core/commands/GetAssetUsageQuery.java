...
/**
 * Query to list all usage records (mileage / operating hours) for an asset.
 */
public class GetAssetUsageQuery implements Query<PaginationResponse> {
    ...
    /**
     * Creates a new GetAssetUsageQuery.
     *
     * @param agreementId the unique identifier of the agreement
     * @param assetId     the unique identifier of the asset
     */
    public GetAssetUsageQuery(UUID agreementId, UUID assetId) {
