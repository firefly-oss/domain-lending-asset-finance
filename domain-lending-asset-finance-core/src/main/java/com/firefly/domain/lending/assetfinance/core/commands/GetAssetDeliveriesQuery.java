...
/**
 * Query to list all delivery records for an asset.
 */
public class GetAssetDeliveriesQuery implements Query<PaginationResponse> {
    ...
    /**
     * Creates a new GetAssetDeliveriesQuery.
     *
     * @param agreementId the unique identifier of the agreement
     * @param assetId     the unique identifier of the asset
     */
    public GetAssetDeliveriesQuery(UUID agreementId, UUID assetId) {
