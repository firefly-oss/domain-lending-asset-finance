...
/**
 * Query to list all pickup records for an asset.
 */
public class GetAssetPickupsQuery implements Query<PaginationResponse> {
    ...
    /**
     * Creates a new GetAssetPickupsQuery.
     *
     * @param agreementId the unique identifier of the agreement
     * @param assetId     the unique identifier of the asset
     */
    public GetAssetPickupsQuery(UUID agreementId, UUID assetId) {
